...
export default function TreatmentItem(props: TreatmentItemProps) {
  const { data } = props;
  return (
    <div className={`aspect-[1/1] md:aspect-[1.2/1] lg:aspect-[669/482] rounded-bl-[32px] md:rounded-bl-[100px] border-y-[1px] border-l-[1px] max-w-[320px] sm:max-w-[480px] lg:max-w-[669px] flex-shrink-0 p-[16px] md:p-[60px] border-[#434343] relative flex flex-col justify-between ${props.className}`}
    >
